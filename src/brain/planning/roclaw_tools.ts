...
import { BytecodeCompiler, Opcode, formatHex } from '../../control/bytecode_compiler';
import { UDPTransmitter } from '../../bridge/udp_transmitter';
import { VisionLoop } from '../perception/vision_loop';
import { CerebellumInference } from '../inference/inference';
import type { InferenceFunction } from '../../llmunix-core/interfaces';
import { GeminiRoboticsInference } from '../inference/gemini_robotics';
import { MemoryManager } from '../memory/memory_manager';
import { PoseMap, SemanticMap } from '../memory/semantic_map';
import { SemanticMapLoop } from '../memory/semantic_map_loop';
import { HierarchicalPlanner, type ExecutionPlan } from './planner';
import { HierarchyLevel, TraceOutcome } from '../memory/trace_types';
...
export interface ToolContext {
  ...
  sceneGraph?: import('../memory/scene_graph').SceneGraph;
}
